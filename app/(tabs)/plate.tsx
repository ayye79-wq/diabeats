...
export default function PlateAnalysisScreen() {
  ...
  const analyze = useCallback(async (asset: ImagePicker.ImagePickerAsset) => {
    ...
    setPhase("loading");
    setError("");
    trackWebEvent("plate_scan_started", {
    ...
    try {
      ...
      setUnits({});
      setPhase("results");
      trackWebEvent("plate_scan_completed", {
      ...
      setPhase("error");
      trackWebEvent("plate_scan_failed");
    }
  ...
  const updatePortion = useCallback((item: MealPhotoItem, text: string) => {
    ...
    setSaved(false);
    trackWebEvent("plate_portion_updated", {
  ...
  const saveMeal = useCallback(async () => {
    ...
    try {
      ...
      trackWebEvent("plate_analysis_saved", {
                ...
                {item.nutrition && !item.confirmed ? (
                  <Pressable
                    onPress={() => {
                      ...
                      setSaved(false);
                      trackWebEvent("provider_match_confirmed", {
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Pressable
                    onPress={() => {
                      ...
                      setSaved(false);
                      trackWebEvent("smart_portion_swap_applied", {
                        nutrition_status: analysis.nutritionStatus,
                      });
                    }}
                    accessibilityRole="button"
