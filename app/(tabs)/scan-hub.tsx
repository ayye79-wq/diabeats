  ...
  return (
    <View style={[styles.container, { backgroundColor: c.background }]}>
      ...
      >
        ...
        <Pressable
          onPress={() => {
            trackAnalyticsEvent("scan_type_selected", { scan_type: "plate" });
        ...
        <Pressable
          onPress={() => {
            trackAnalyticsEvent("scan_type_selected", { scan_type: "menu" });
        ...
        <Pressable
          onPress={() => {
            trackAnalyticsEvent("scan_type_selected", { scan_type: "product" });
